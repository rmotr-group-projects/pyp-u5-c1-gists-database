...
def import_gists_to_database(db, username, commit=True):
    ...
    # resp = requests.get('https://api.github.com/users/'+ username + '/gists')

    gists_data = resp.json() # list of dicts
    # dict_keys(['url', 'forks_url', 'commits_url', 'id', 'git_pull_url', 'git_push_url', 
    # 'html_url', 'files', 'public', 'created_at', 'updated_at', 'description', 'comments', 
    # 'user', 'comments_url', 'owner', 'truncated'])
